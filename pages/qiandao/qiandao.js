	...
	calculateDays(year, month) {
        ...
        for (let i = 1; i <= thisMonthDays; i++) {
            if(month_s > openitem){
                ...
                this.data.days.push({wook:i,src:i <= getDate?'/images/p1.png':''});
                ...
                if((Y+''+M) == month_s && this.data.opentime[2] <= i && i <= (this.data.ornot?this.data.getDate:this.data.getDate-1)){
                    this.data.days.push({wook:i,src:'/images/p1.png'});
                ...
                this.data.days.push({wook:i,src:this.data.opentime[2] <= i?'/images/p1.png':''});
            }else if(openitem < month_s && month < this.data.shuttime[1]){
                this.data.days.push({wook:i,src:'/images/p1.png'});
            }else{
                this.data.days.push({wook:i,src:''});
    ...
    sigarr:function(e){
        ...
        for(let i = 0;i < num;i++){
            if(i <= (obinl + 1)){ 
                if(ornot == 0){
                    if(0 <= (obinl - i - 1)){
                        that.data.day[obinl - i - 1].src = "/images/p1.png"
                    }
                }else{
                    if(0 <= (obinl - i - 2)){
                        that.data.day[obinl - i - 2].src = "/images/p1.png"
                    }
                }
            }else{
                return false
